...
export default function Destinations() {
  ...
  return (
    <section id="destinations" className="py-14 bg-white overflow-hidden">
      <div className="max-w-md mx-auto">
        {/* Header */}
        <div className="px-6 mb-8">
          <h2 className="font-display text-[#0A1628] text-2xl font-bold">
        ...
        <div className="relative">
          <div className="flex items-center justify-center gap-4 px-6 transition-all duration-500">
            {[-1, 0, 1].map((offset) => {
              ...
              return (
                <div
                  ...
                  className={`relative flex-shrink-0 overflow-hidden transition-all duration-500 cursor-pointer 
                    ${isCenter
                      ? 'w-40 h-56 shadow-lg shadow-[#0A1628]/20 scale-100'
                      : 'w-40 h-56 opacity-100 scale-100'
                    }`}
                >
                  <img
                    src={dest.image}
